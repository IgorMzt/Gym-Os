...
from routes.api import api_auth_bp, api_aluno_bp, api_treinos_bp, api_historico_bp, api_evolucao_bp, api_financeiro_bp, api_notificacoes_bp, api_experiencia_bp
